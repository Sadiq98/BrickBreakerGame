...
public class GamePanel extends JPanel implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        if(ballpt.x-RADIUS<=0 || ballpt.x+RADIUS>=getWidth())
        {
            ...
            try
            {
                in3 =  getClass().getResourceAsStream("/BrickBreaker/Sounds/hit.wav");
            }
            catch(Exception es)
            {
        ...
        if(ballpt.y-RADIUS<=0)
        {
            ...
            try
            {
                in3 =  getClass().getResourceAsStream("/BrickBreaker/Sound/hit.wav");
            }
            catch(Exception es)
            {
                  ...
                  || ballpt.y-RADIUS>=bricks[i].y && ballpt.y-RADIUS<=bricks[i].y+brickHeight)
                    {
                        try
                        {
                             ...
                             in =  getClass().getResourceAsStream("/BrickBreaker/Sound/sound.wav");
...
//             in1 =  new FileInputStream("F:\\JAVA\\Netbeans\\Netbeans\\Brick Breaker\\src\\keyboarddemo\\Sounds\\start.wav");
            in1 =  getClass().getResourceAsStream("/BrickBreaker/Sound/start.wav");
        }
        catch(Exception es)
        {
        ...
        AudioPlayer.player.start(as1);
         ...
         try
        {
            in2 =  getClass().getResourceAsStream("/keyboarddemo/Sound/end.wav");
        }
        catch(Exception es)
        {
        ...
        bgimg = Toolkit.getDefaultToolkit().createImage(getClass().getResource("/keyboarddemo/Image/pic.jpg"));
         try 
        {                
           image = ImageIO.read(getClass().getResource("/BrickBreaker/Image/pic1.jpg"));
        } 
        ...
        try 
        {                
            paddleImage = ImageIO.read(getClass().getResource("/BrickBreaker/Image/paddle.jpg"));
        } 
        catch(IOException ex) 
        {
            // handle exception...
